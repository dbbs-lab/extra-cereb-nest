...
/*
 * There are three scenarios, in which ExtracerebModule can be loaded by NEST:
 *
...
mynest::ExtracerebModule extra-cerebmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::ExtracerebModule::ExtracerebModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::ExtracerebModule::name( void ) const
{
  return std::string( "Extracereb Module" ); // Return name of the module
}

const std::string
mynest::ExtracerebModule::commandstring( void ) const
{
...
void
mynest::ExtracerebModule::init( SLIInterpreter* i )
{
