...
/*
 * There are three scenarios, in which Extra-cerebModule can be loaded by NEST:
 *
...
mynest::Extra-cerebModule extra-cerebmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::Extra-cerebModule::Extra-cerebModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::Extra-cerebModule::name( void ) const
{
  return std::string( "Extra-cereb Module" ); // Return name of the module
}

const std::string
mynest::Extra-cerebModule::commandstring( void ) const
{
  // Instruct the interpreter to load extra-cerebmodule-init.sli
  return std::string( "(extra-cerebmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::Extra-cerebModule::init( SLIInterpreter* i )
{
